    ...
    return (
        ...
        >
            ...
            <h2
                ...
                mb-4 text-4xl font-extrabold leading-none tracking-tight text-white md:text-5xl lg:text-6xl dark:text-white'
            >
                Password Generator
            </h2>
            <div
                    ...
                    <React.Fragment>
                        ...
                        <div className='flex items-center justify-center h-screen'>
                            <div className='p-4 rounded-lg shadow-md w-64 bg-white flex flex-col items-center'>
                                <h2 className='text-lg font-bold mb-4'>Elevate Your Security</h2>
                                <p className='text-center mb-4 font-serif'>Enter the Password Realm, Where Every Code Sparks Safety, and Your Online Journey Begins with Unmatched Resilience!</p>
